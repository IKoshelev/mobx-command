...
describe('command ', function () {
    ...
    it('when canExecute function is passed, it is used, lazily', function () {
        var counter = 0;
        var com = index_1.command({
            execute: function () {
                return true;
    ...
    it('canExecute can be instructed to execute immediately', function () {
        var counter = 0;
        var com = index_1.command({
    ...
    it('canExecute function, that returns a Promise<boolean>, can be set to execute immediately', function () { return __awaiter(_this, void 0, void 0, function () {
        var resolver, prom, counter, com;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('command function promise rejection, is also used to track execution and set isExecuting', function () { return __awaiter(_this, void 0, void 0, function () {
        var rejector, prom, promisesRejectedCounter, incrementPromiseRejectionCounter, com, ex_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
